...
public class EntryAndExitFileUtils {

    public static String appendFileName = "E:\\20190808\\日志数据\\data\\entry_exit.txt";
    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            int line = 1;
            String matchStr1 = "method = EntryData params =";
            String matchStr2 = "method = ExitData params =";
