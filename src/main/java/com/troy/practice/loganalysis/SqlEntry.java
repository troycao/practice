...
public class SqlEntry {
    ...
    public static String appendSqlFile = "E:\\20190808\\日志数据\\sql\\sql_entry.txt";

    public static void main(String[] args) {
        String fileName = "E:\\20190808\\日志数据\\data\\entry.txt";
    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                String EntryTime = (String) object.getJSONObject("data").get("EntryTime");
                ...
                if (!"".equals(data) && !StringUtils.isEmpty(data)){
                    ...
                    if (dataObject != null){
                        ...
                        sql = "INSERT INTO pims_entry(platenum,entrytime,parkId,parkname) VALUES('"+ plateNum
                                +"','"+ EntryTime
                                +"','"+ parkId
                                +"','"+ parkname +"');";
